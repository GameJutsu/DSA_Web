...
Keep this list updated after each discussion. Capture what to learn, why, and suggested resources.

## How to use
- Append new items at the top under "Open".
- Move items to "Done" once completed; keep a short note of what you learned.
...
## Done
- (move finished items here with a brief takeaway)
